        ...
        <Dropdown backdrop="blur" placement="bottom-start" className="bg-white  text-[#FF0000] ml-[3vh] z-[9999999] relative top-[-0.30em]" >
          <DropdownTrigger>
                ...
                text-[#FF0000] cursor-pointertransition-all 0.3s z-[9999999]" fontSize={25} onClick={()=>setIsBurgerOpen(false)}/> : */}
                 <CgMenu className="z-[9999999] text-[#FF0000] cursor-pointer" fontSize={26} onClick={()=>setIsBurgerOpen(true)}/>
...
<Button as={Link}  variant="shadow" className="bg-[#FF0000] hidden tablet:flex laptop:hidden theme-primary-color text-white" style={{boxShadow:"rgb(255, 0, 0) 0px 7px 15px -7px"}} onClick={()=>FirebaseContext.openModal("DL")}>

<PiDownloadSimpleBold className="text-xl"/>

    </Button>

  <Button as={Link}  variant="shadow" className="bg-[#FF0000]  hidden laptop:flex theme-primary-color text-white" style={{boxShadow:"rgb(255, 0, 0) 0px 7px 15px -7px"}} onClick={()=>FirebaseContext.openModal("DL")}>
