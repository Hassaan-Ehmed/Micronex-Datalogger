                    ...
                    <div className=" modal-container w-11/12  max-w-md mx-auto   z-50 overflow-y-auto shadow-2xl p-2 rounded-2xl border-2 border-gray-50 bg-white">
                        <div className="modal-content py-4 text-left px-6">
                            <div className="flex justify-between items-center pb-3">
                                <p className="text-2xl font-bold text-primary">Full Screen</p>
                            ...
                            <div className="my-5">
                                <p className='text-primary'>Do you want Full Screen mode ?</p>
                            </div>
                            <div className="flex justify-end pt-2 gap-4">
                             <Button  variant="light" className="LM425:flex text-primary"  onClick={pleaseCloseTheModal}>
                               No
                                ...
                                <Button id='logout-btn' variant="shadow" className="bg-primary LM425:flex text-foreground shadow-lg shadow-primary"
